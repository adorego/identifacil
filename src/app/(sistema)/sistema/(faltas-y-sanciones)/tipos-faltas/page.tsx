...
const header2 = [
    ...
    {id: 'maximo_dias_de_sancion', label: 'Descripcion'},
]
...
export default function Page() {
    ...
    useEffect(() => {
        fetchData(`${API_URL}/faltas_sanciones/tipos_de_faltas`)
            .then(fetchedData => {
    ...
    return (
        <>
            <Box >
                ...
                <TituloComponent titulo='Tipo de faltas'>
                    <BreadCrumbComponent listaDeItems={[
                        {nombre:'Lista de tipo de faltas', url:'', lastItem: true},
                    ]} />
                </TituloComponent>
                <Box mt={4} component={Paper}>
                    <CustomTable
                        ...
                        options={{
                            title: 'Lista de tipos de faltas',
                            newRecord: '/sistema/tipos-faltas/crear',
                            targetURL: '/sistema/tipos-faltas',
                            rowsPerPageCustom: 5,
                            pagination: true,
                        }}
                    />
