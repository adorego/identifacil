...
interface datosSalud {
    numeroDeIdentificacion: string | null | any;
...
const datosSaludSelectInicial: datosSaludSelect = {
    ...
    vacunas_recibidas: [{id: 1, label: "Covid 1era dosis"}, {id: 2, label: "Covid 2da dosis"}, {
        id: 3,
        label: "Covid 3era dosis"
    }]
}
    ...
    switch (action.type) {
        case (SALUD_ACTIONS.MODIFICAR_AFECCION_DROGA):
            return Object.assign({}, {
                ...state,
                drogasModificado: true,
                tieneAfeccionADrogras: (action.payload === "true")
            });
        case (SALUD_ACTIONS.MODIFICAR_GRUPO_SANGUINEO):
            return Object.assign({}, {
                ...state,
                grupo_sanguineo_modificado: true,
                grupo_sanguineo: (action.payload.id)
            });
        ...
        case (SALUD_ACTIONS.MODIFICAR_FRECUENCIA_CARDIACA):
            return Object.assign({}, {
                ...state,
                frecuencia_cardiaca: action.payload,
                frecuencia_cardiaca_modificada: true
            });
        case (SALUD_ACTIONS.MODIFICAR_FRECUENCIA_RESPIRATORIA):
            return Object.assign({}, {
                ...state,
                frecuencia_respiratoria: action.payload,
                frecuencia_respiratoria_modificada: true
            });
        ...
        case (SALUD_ACTIONS.MODIFICAR_SIGUE_TRATAMIENTO_MENTAL):
            return Object.assign({}, {
                ...state,
                sigue_tratamiento_mental_modificado: true,
                sigue_tratamiento_mental: (action.payload === "true")
            });
        case (SALUD_ACTIONS.MODIFICAR_TIENE_ANTECEDENTES_LESIONES_AUTOINFLINGIDAS):
            return Object.assign({}, {
                ...state,
                tiene_antecedentes_de_lesiones_autoinflingidas_modificado: true,
                tiene_antecedentes_de_lesiones_autoinflingidas: (action.payload === "true")
            });
        case (SALUD_ACTIONS.MODIFICAR_HA_ESTADO_INTERNADO_EN_PSIQUIATRICO):
            return Object.assign({}, {
                ...state,
                ha_estado_internado_en_hospital_psiquiatrico_modificado: true,
                ha_estado_internado_en_hospital_psiquiatrico: (action.payload === "true")
            });
        case (SALUD_ACTIONS.MODIFICAR_REPORTA_ABUSO_DE_DROGA_PREVIO_AL_INGRESO):
            return Object.assign({}, {
                ...state,
                reporta_abuso_de_droga_previo_al_ingreso_modificado: true,
                reporta_abuso_de_droga_previo_al_ingreso: (action.payload === "true")
            });
        ...
        case (SALUD_ACTIONS.MODIFICAR_TIENE_AFECCION_SEVERA_POR_ESTUPEFACIENTE):
            return Object.assign({}, {
                ...state,
                tiene_afeccion_severa_por_estupefaciente_modificado: true,
                tiene_afeccion_severa_por_estupefacientes: (action.payload === 'true')
            })
        case (SALUD_ACTIONS.MODIFICAR_NECESITA_INTERPRETE):
            return Object.assign({}, {
                ...state,
                necesitaInterprete_modificado: true,
                necesitaInterprete: (action.payload === "true")
            });
        case (SALUD_ACTIONS.MODIFICAR_TIENE_DIFICULTAD_PARA_LEER_Y_ESCRIBIR):
            return Object.assign({}, {
                ...state,
                tieneDificultadParaLeerYEscribir_modificado: true,
                tieneDificultadParaLeerYEscribir: (action.payload === "true")
            });
...
const BloqueSalud: FC<BloqueSaludProps> = ({numeroDeIdentificacion, datosAlmacenados = datosSaludInicial}) => {
    ...
    const onVacunasRecibidasAdd = (event: React.SyntheticEvent, value: Array<{
        id: number,
        label: string
    }>, reason: string) => {
        // console.log(value);
    ...
    const onSigueTratamientoMentalChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        // console.log(event.currentTarget.value);
        datosSaludDispatch({
            type: SALUD_ACTIONS.MODIFICAR_SIGUE_TRATAMIENTO_MENTAL,
    ...
    const onTieneAntecedentesDeLesionesAutoinflingidasChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        datosSaludDispatch({
            type: SALUD_ACTIONS.MODIFICAR_TIENE_ANTECEDENTES_LESIONES_AUTOINFLINGIDAS,
            payload: event.currentTarget.value
        });
    }
    ...
    const onHaEstadoInternadoEnPsiquiatricoChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        datosSaludDispatch({
            type: SALUD_ACTIONS.MODIFICAR_HA_ESTADO_INTERNADO_EN_PSIQUIATRICO,
            payload: event.currentTarget.value
        });
    }
    ...
    const onReportaAbusoDeDrogaPrevioAlIngresoChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        datosSaludDispatch({
            type: SALUD_ACTIONS.MODIFICAR_REPORTA_ABUSO_DE_DROGA_PREVIO_AL_INGRESO,
            payload: event.currentTarget.value
        });
    }
    ...
    const onTieneAfeccionSeveraPorEstupefacientes = (event: React.ChangeEvent<HTMLInputElement>) => {
        console.log(event.currentTarget.value);
        datosSaludDispatch({
            type: SALUD_ACTIONS.MODIFICAR_TIENE_AFECCION_SEVERA_POR_ESTUPEFACIENTE,
            payload: event.currentTarget.value
        });
    }
    ...
    const onTieneDificultadParaLeerYEscribirChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        console.log(event.currentTarget.value);
        datosSaludDispatch({
            type: SALUD_ACTIONS.MODIFICAR_TIENE_DIFICULTAD_PARA_LEER_Y_ESCRIBIR,
            payload: event.currentTarget.value
        });
    }
                    ...
                    <Grid item sm={6}>
                        <FormControl>
                            ...
                            <Autocomplete
                                ...
                                options={[]}
                                freeSolo
                                /*TODO: Aca da error porque falta un key
