...
import {dataMovimientoInterno, dataSalidasEspeciales} from "@/app/dummyData/movimientosDummyData";

export default function Ppl() {
    const [data, setData] = useState(null);

    // Datos Dummy
    const dummySalidasEspeciales = dataMovimientoInterno();
    ...
    return (
        <Box>
            <Box mb={3}>
                <TituloComponent titulo='Movimiento interno' url='/movimientos/movimiento-interno' newEntry='/movimientos/movimiento-interno/crear' />
            </Box>
            <Paper elevation={1}>
                <Box p={3}>
                    <FiltrosTables/>
